...
public class HorizontalLineBlock extends BaseBlock
{
    ...
    private HexagonRelation relation = new HexagonRelation();
    ...
    {
        if (initWidthMeasureSpec == 0)
            initWidthMeasureSpec = widthMeasureSpec;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b)
    {
        ...
        switch (blockType)
        {
            case SINGLE_BLOCK:
                ...
                break;
            case HORIZONTAL_4_BLOCK:
                for (int i = 0; i < relation.path.length; i++)
                {
                    relation.path[i] = HexagonRelation.R; // ->右->右->右
                }
                for (int i = 0; i < getChildCount(); i++)
                {
                    childView = (HexagonView) getChildAt(i);
                    childView.layout(startLeft, startTop, startLeft + childView.getMeasuredWidth(),
            ...
            case LEFT_BOTTOM_4_BLOCK:
                for (int i = 0; i < relation.path.length; i++)
                {
                    relation.path[i] = HexagonRelation.RB; // ->右下->右下->右下
                }
                for (int i = 0; i < getChildCount(); i++)
                {
                    childView = (HexagonView) getChildAt(i);
            ...
            case LEFT_TOP_4_BLOCK:
                for (int i = 0; i < relation.path.length; i++)
                {
                    relation.path[i] = HexagonRelation.LB; // ->左下->左下->左下
                }
            ...
            case LEFT_RHOMBUS_BLOCK:
                ...
                relation.path[0] = HexagonRelation.R; // ->右->左下->右
                relation.path[1] = HexagonRelation.LB;
                relation.path[2] = HexagonRelation.R;
            ...
            case CENTER_RHOMBUS_BLOCK:
                ...
                relation.path[0] = HexagonRelation.RB; // ->右下->左下->左上
                relation.path[1] = HexagonRelation.LB;
                relation.path[2] = HexagonRelation.LT;
            ...
            case RIGHT_RHOMBUS_BLOCK:
                ...
                relation.path[0] = HexagonRelation.R; // ->右->左下->左
                relation.path[1] = HexagonRelation.LB;
                relation.path[2] = HexagonRelation.L;
            ...
            case ARC_ROTATE_0:
                ...
                relation.path[0] = HexagonRelation.RT; // ->右上->右->右下
                relation.path[1] = HexagonRelation.R;
                relation.path[2] = HexagonRelation.RB;

                startTop = (int) (getChildAt(0).getMeasuredHeight() * 0.75);
                for (int i = 0; i < getChildCount(); i++)
                {
                    childView = (HexagonView) getChildAt(i);
                    childView.layout(startLeft, startTop, startLeft + childView.getMeasuredWidth(),
            ...
            case ARC_ROTATE_60:
                ...
                relation.path[0] = HexagonRelation.R; // ->右->右下->左下
                relation.path[1] = HexagonRelation.RB;
                relation.path[2] = HexagonRelation.LB;
            ...
            case ARC_ROTATE_120:
                ...
                relation.path[0] = HexagonRelation.RB; // ->右下->左下->左
                relation.path[1] = HexagonRelation.LB;
                relation.path[2] = HexagonRelation.L;
            ...
            case ARC_ROTATE_180:
                ...
                relation.path[0] = HexagonRelation.RB; // ->右下->右->右上
                relation.path[1] = HexagonRelation.R;
                relation.path[2] = HexagonRelation.RT;
            ...
            case ARC_ROTATE_240:
                ...
                relation.path[0] = HexagonRelation.LB; // ->左下->右下->右
                relation.path[1] = HexagonRelation.RB;
                relation.path[2] = HexagonRelation.R;
            ...
            case ARC_ROTATE_300:
                ...
                relation.path[0] = HexagonRelation.L; // ->左->左下->右下
                relation.path[1] = HexagonRelation.LB;
                relation.path[2] = HexagonRelation.RB;
            ...
            case GUN_0_LEFT:
                ...
                relation.path[0] = HexagonRelation.L; // ->左->左->右下
                relation.path[1] = HexagonRelation.L;
                relation.path[2] = HexagonRelation.RB;
            ...
            case GUN_0_RIGHT:
                ...
                relation.path[0] = HexagonRelation.R; // ->右->右->左下
                relation.path[1] = HexagonRelation.R;
                relation.path[2] = HexagonRelation.LB;
            ...
            case GUN_60_LEFT:
                ...
                relation.path[0] = HexagonRelation.RT; // ->右上->右下->右下
                relation.path[1] = HexagonRelation.RB;
                relation.path[2] = HexagonRelation.RB;
            ...
            case GUN_60_RIGHT:
                ...
                relation.path[0] = HexagonRelation.RB; // ->右下->右下->左
                relation.path[1] = HexagonRelation.RB;
                relation.path[2] = HexagonRelation.L;
            ...
            case GUN_120_LEFT:
                ...
                relation.path[0] = HexagonRelation.R; // ->右->左下->左下
                relation.path[1] = HexagonRelation.LB;
                relation.path[2] = HexagonRelation.LB;
            ...
            case GUN_120_RIGHT:
                ...
                relation.path[0] = HexagonRelation.RB; // ->右下->右上->右上
                relation.path[1] = HexagonRelation.RT;
                relation.path[2] = HexagonRelation.RT;
            ...
            case GUN_180_LEFT:
                ...
                relation.path[0] = HexagonRelation.LB; // ->左下->右->右
                relation.path[1] = HexagonRelation.R;
                relation.path[2] = HexagonRelation.R;
            ...
            case GUN_180_RIGHT:
                ...
                relation.path[0] = HexagonRelation.RB; // ->右下->左->左
                relation.path[1] = HexagonRelation.L;
                relation.path[2] = HexagonRelation.L;
            ...
            case GUN_240_LEFT:
                ...
                relation.path[0] = HexagonRelation.L; // ->左->右下->右下
                relation.path[1] = HexagonRelation.RB;
                relation.path[2] = HexagonRelation.RB;
            ...
            case GUN_300_LEFT:
                ...
                relation.path[0] = HexagonRelation.RT; // ->左下->左下->右下
                relation.path[1] = HexagonRelation.RT;
                relation.path[2] = HexagonRelation.RB;

                startTop += getChildAt(0).getMeasuredHeight() * 1.5;
                for (int i = 0; i < getChildCount(); i++)
                {
                    childView = (HexagonView) getChildAt(i);
                    childView.layout(startLeft, startTop, startLeft + childView.getMeasuredWidth(),
            ...
            case GUN_300_RIGHT:
                ...
                relation.path[0] = HexagonRelation.LB; // ->左下->左下->右
                relation.path[1] = HexagonRelation.LB;
                relation.path[2] = HexagonRelation.R;
    ...
    public void expandSize(int width, int height)
    { // 若width和height同时为零，则为当前block的大小为xml中定义的大小,此处设置的宽高是小六边形的宽高

        // if(width<=MeasureSpec.getSize(initWidthMeasureSpec)) width = 0;
        // //当block的小六边形的宽高小于初始宽高时，直接置0，这样measureSize()时，会自动回复到默认的初始宽高
    ...
    public void measureSize(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        { // 此时用于填充的移动模块的各个小六边形的宽高为标准宽高*0.8，单个模块宽高为标准宽高
        ...
        // ZYMLog.info("childWidth is "+childWidth+" childHeight is
        // "+childHeight);
        for (int i = 0; i < getChildCount(); i++)
        {
        ...
        // ZYMLog.info("leftMargin is "+lp.leftMargin+" topMargin is
        // "+lp.topMargin);
    ...
    public void setStandardWidth(int standardWidth)
    {
        ...
        // ZYMLog.info(" W---- standardWidth is "+standardWidth+"
        // singleBlockHeight is "+singleBlockHeight );
    ...
    public void setStandardHeight(int standardHeight)
    {
        ...
        // ZYMLog.info(" H---- singleBlockWidth is "+singleBlockWidth+"
        // standardHeight is "+standardHeight );
