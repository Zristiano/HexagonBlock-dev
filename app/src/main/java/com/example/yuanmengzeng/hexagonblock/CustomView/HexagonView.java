...
public class HexagonView extends View
{
    ...
    private HexagonRelation hexagonRelation; // 每个小六边形的邻接关系类
    ...
    private void init()
    {
        ...
        hexagonRelation = new HexagonRelation();
    }
    ...
    private void setBackGroundAlpha(int alpha)
    {
        ...
        hexBackGroundColor = Color.argb(alpha, Color.red(hexBackGroundColor), Color.green(hexBackGroundColor),
                Color.blue(hexBackGroundColor));
    }
     ...
     * @param hexagonView 邻接六边形
     */
    public void setAdjacentHexagon(int adjPos, HexagonView hexagonView)
    {
        if (adjPos >= HexagonRelation.LT && adjPos <= HexagonRelation.L)
        {
            hexagonRelation.adjacentMatrix[adjPos] = hexagonView;
        }
    }
     ...
     * @return 邻接六边形
     */
    public HexagonView getAdjacentHexagon(int adjPos)
    {
        if (adjPos >= HexagonRelation.LT && adjPos <= HexagonRelation.L)
        {
            return hexagonRelation.adjacentMatrix[adjPos];
        }
        else
        {
            return null;
